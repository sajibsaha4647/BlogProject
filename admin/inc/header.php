            ...
            <div id="branding">
                ...
                <div class="floatright">
                    <div class="floatleft">
                        ...
                        if (isset($user_image)) {
                        ?>
                            <img style="width:30px;height:30px" src="<?php echo $user_image ?>" alt="Profile Pic" /></div>
                <?php } ?>
        ...
        <div class="grid_12">
            <ul class="nav main">
                ...
                <li class="ic-grid-tables"><a href="inbox.php"><span>Inbox
                            <?php
                            $sql = "SELECT * FROM blog_contactus where staus='0' order by con_id desc";
                            $read = $db->conn->query($sql);
                            if ($read) {
